...
<script src="${pageContext.request.contextPath}/resources/bootstrap/js/bootstrap-affix.js"></script>
<script src="${pageContext.request.contextPath}/resources/bootstrap/js/bootstrap-alert.js"></script>
...
<script src="${pageContext.request.contextPath}/resources/bootstrap/js/bootstrap-scrollspy.js"></script>
<script src="${pageContext.request.contextPath}/resources/bootstrap/js/bootstrap-tab.js"></script>
<script src="${pageContext.request.contextPath}/resources/bootstrap/js/bootstrap-tooltip.js"></script>
<script src="${pageContext.request.contextPath}/resources/bootstrap/js/bootstrap-transition.js"></script>
<script src="${pageContext.request.contextPath}/resources/bootstrap/js/bootstrap-typeahead.js"></script>